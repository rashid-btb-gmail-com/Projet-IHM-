...
<input class="inp_insc" type="text" name="nom" placeholder="Nom" required onchange="verifier_champs()">                                      <span class="controle" id="etat_nom" ></span><br>
    ...
    <input class="inp_insc" type="text" name="username" placeholder="Pseudo" required onchange="verifier_champs()">                          <span class="controle" ></span><br>
    
<input class="inp_insc" type="text" name="email" placeholder="E-mail" required onchange="verifier_champs()">                                 <span class="controle" ></span><br>

    <input class="inp_insc" type="password" id="mdp" name="password" placeholder="Mot de passe" required onchange="verifier_champs()" >      <span class="controle" ></span><br>
    <input class="inp_insc" type="password" id="mdp2" name="confirm_password" placeholder="Confirmer mot de passe" required onchange="saisie_champ()"><span class="controle" ></span><br>
    
    <input class="inp_insc" type="tel" name="tel" placeholder="Numéro de telephone" required onchange="verifier_champs()">                   <span class="controle" ></span><br>
    <input class="inp_insc" list="sitfam" name="sit_fam" placeholder="Situation familiale" required onchange="verifier_champs()">            <span class="controle" ></span><br>
            <datalist id="sitfam">
            <option value="Marié">
